...
import requests # get the page's html by making a getRequest
import time
import csv

# Url for website
START_URL = "https://exoplanets.nasa.gov/exoplanet-catalog/"
browser = webdriver.Chrome("/Users/Rajjo/Python/C128/chromedriver")
...
# Function for scraping more data (for hyperlink)      
def scrape_more_data(hyperlink):
    try:
        page = requests.get(hyperlink)
        print(hyperlink.content)
